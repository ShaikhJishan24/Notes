...
public class EmailSender {
	...
	public void send(String subject, MultipartFile filename, String message) {
		...
		Session session = Session.getInstance(props, // mail api session
		...
		try {
			...
			message1.setRecipients(Message.RecipientType.TO, InternetAddress.parse("nitin.javastudent@gmail.com"));
			...
			DataSource source = new FileDataSource(filePath); // mail Api DataSource
