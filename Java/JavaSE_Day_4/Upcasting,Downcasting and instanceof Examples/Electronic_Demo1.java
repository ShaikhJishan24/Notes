...
{
	static void perform(Electronic_Appliance ref) // Electronic_Appliance ref = new Washing_Machine()
	{
		ref.on();
		ref.off();
		...
		{
			Washing_Machine w=(Washing_Machine)ref; // ref is of type Electronic_Appliance
			w.fillWater();
		}
	}
