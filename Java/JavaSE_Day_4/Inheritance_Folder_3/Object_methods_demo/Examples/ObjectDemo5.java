class MyNum
{
	...
	public boolean equals(MyNum ref) // MyNum ref = m2
	{
		System.out.println("equals with MyNum");
		return num==ref.num; // 100 == 
	}
}
...
// Original method in Object class:
...
// ➡ So Java treats it as a new method, NOT an override it is overloding.
