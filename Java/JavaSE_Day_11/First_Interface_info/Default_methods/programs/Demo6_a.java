...
interface emp1 extends emp {
	...
	default String disp2() {
		...
		// System.out.println(super.disp2()); // super reference is illegal in interface
		// context
...
class MyClass implements emp1 {
	...
	public String disp2() {
		...
		// System.out.println(super.disp2()); // error: The method disp2() is undefined
		// for the type Object
		// System.out.println(emp.super.disp2()); //Illegal reference to super type emp,
		// cannot bypass the more specific direct super type emp1
