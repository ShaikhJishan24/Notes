...
public class Demo8 {
	public static void main(String args[]) {
		...
		Collections.sort(mylist, new NameSorter()); // sort(list, Comparator)
		...
		System.out.println();
		// Comparator<Person> namestrategy=(Person a,Person b)->{return
		// a.getName().compareTo(b.getName());};
		Collections.sort(mylist, (a, b) -> { // implementation for the comparator interface
