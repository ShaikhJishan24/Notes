...
class MyAccount extends Account  { 
	...
	private void writeObject(ObjectOutputStream o) throws IOException
	{
		...
		o.defaultWriteObject(); // Then o.defaultWriteObject() serializes all other fields (username, details, Account fields).
		                        // Entire object graph → Account (superclass), BankDetails (has-a), and all fields → are stored.
	}
